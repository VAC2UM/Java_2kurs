...
public class TestStudent {
    public static void main(String[] args) {
        ...
        Student student1 = new Student("John", "Doe", 12345, 3.4, "Group A", "2nd Year", "Computer Science");
        Student student2 = new Student("Alice", "Smith", 56789, 3.5, "Group B", "3rd Year", "Engineering");
        Student student3 = new Student("Bob", "Johnson", 23456, 3.2, "Group A", "2nd Year", "Computer Science");
        Student student4 = new Student("Eve", "Williams", 98765, 2.9, "Group C", "4th Year", "Mathematics");
        Student student5 = new Student("Lev", "Brown", 95456, 4.0, "Group B", "3rd Year", "Engineering");
